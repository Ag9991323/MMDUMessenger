...
public class FirestoreUsersAdapter extends FirestoreRecyclerAdapter<Users,FirestoreUsersAdapter.myholder> {
    Context context;
    FirebaseAuth mAuth;
     ...
     * @param options
     */
    public FirestoreUsersAdapter(@NonNull FirestoreRecyclerOptions<Users> options,Context context) {
        super(options);
